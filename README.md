...
## openni2_camera (melodic) - 1.6.0-2

The packages in the `openni2_camera` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic openni2_camera --edit` on `Tue, 12 Apr 2022 10:26:17 -0000`
...
## openni2_camera (melodic) - 1.6.0-1

The packages in the `openni2_camera` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic openni2_camera --edit` on `Tue, 12 Apr 2022 10:12:48 -0000`
...
## openni2_camera (kinetic) - 1.5.1-1

The packages in the `openni2_camera` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic openni2_camera --edit` on `Mon, 01 Feb 2021 15:15:23 -0000`
...
## openni2_camera (melodic) - 1.5.1-1

The packages in the `openni2_camera` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic openni2_camera --edit` on `Mon, 01 Feb 2021 15:07:40 -0000`
...
## openni2_camera (noetic) - 1.5.1-1

The packages in the `openni2_camera` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic openni2_camera --edit` on `Mon, 01 Feb 2021 15:00:24 -0000`
...
## openni2_camera (noetic) - 1.5.0-2

The packages in the `openni2_camera` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic openni2_camera` on `Mon, 01 Feb 2021 14:56:54 -0000`
...
## openni2_camera (noetic) - 1.5.0-1

The packages in the `openni2_camera` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic openni2_camera` on `Tue, 12 Jan 2021 15:03:31 -0000`
...
## openni2_camera (noetic) - 1.4.2-1

The packages in the `openni2_camera` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic openni2_camera --edit` on `Wed, 03 Jun 2020 22:42:39 -0000`
...
## openni2_camera (indigo) - 0.4.2-0

The packages in the `openni2_camera` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo openni2_camera` on `Sun, 02 Dec 2018 01:11:53 -0000`
...
## openni2_camera (kinetic) - 0.4.2-0
...
The packages in the `openni2_camera` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic openni2_camera` on `Wed, 04 May 2016 18:47:07 -0000`
